...
<script>
  export default {
    ...
    created(){
      ...
      this.inputs.name = this.student.studentName
    },
    computed:{
      overallSkills(){
      ...
      student(){
        return this.$store.getters.loadedStudent(this.cohortId, this.studentId)
      },
      cohort(){
        return this.$store.getters.loadedCohort(this.cohortId)
      }
    },
    methods:{
      updateStudent(){
